 ...
 */
export declare const InputOptionContent: {
    ({ children, description, leftGlyph, rightGlyph, }: InputOptionContentProps): React.JSX.Element;
    displayName: string;
};
//# sourceMappingURL=InputOptionContent.d.ts.map