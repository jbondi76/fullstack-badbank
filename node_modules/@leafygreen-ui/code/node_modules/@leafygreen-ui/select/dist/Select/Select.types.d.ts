...
import { DarkModeProps, Either, HTMLElementProps, LgIdProps } from '@leafygreen-ui/lib';
...
export interface BaseSelectProps extends Omit<HTMLElementProps<'button', HTMLButtonElement>, 'onChange' | 'onClick'>, Omit<PopoverProps, 'active' | 'spacing'>, DarkModeProps, LgIdProps {
    /**
