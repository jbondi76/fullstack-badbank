...
export type V11AdapterProps<T extends LGRowData> = PropsWithChildren<Pick<LeafyGreenTableOptions<T>, 'useVirtualScrolling' | 'hasSelectableRows'> & Pick<TableProps<T>, 'shouldAlternateRowColor' | 'className'> & DarkModeProps & {
    /**
...
//# sourceMappingURL=V11Adapter.types.d.ts.map