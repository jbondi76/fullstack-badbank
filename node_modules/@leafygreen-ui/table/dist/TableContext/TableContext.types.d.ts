...
import { LeafyGreenTable, LeafyGreenTableRow, LGRowData } from '../useLeafyGreenTable';
export type TableContextValues<T extends LGRowData> = PropsWithChildren<Pick<TableProps<T>, 'table' | 'shouldAlternateRowColor' | 'disableAnimations'>> & DarkModeProps & {
...
//# sourceMappingURL=TableContext.types.d.ts.map