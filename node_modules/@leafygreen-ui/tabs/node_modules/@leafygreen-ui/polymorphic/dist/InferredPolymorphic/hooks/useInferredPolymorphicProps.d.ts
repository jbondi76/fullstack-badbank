 ...
 */
export declare function useInferredPolymorphicProps<T extends PolymorphicAs, R extends {
    [key: string]: any;
}, D extends PolymorphicAs>(asProp?: T, rest?: R, defaultAs?: D): {
    as: PolymorphicAs;
    href?: string;
} & ComponentPropsWithoutRef<PolymorphicAs>;
//# sourceMappingURL=useInferredPolymorphicProps.d.ts.map