 ...
 */
export declare const usePolymorphicRef: <E extends PolymorphicAs>(_?: E | undefined) => React.MutableRefObject<(E extends keyof HTMLElementTagNameMap ? HTMLElementTagNameMap[E] : unknown) | null>;
/**
