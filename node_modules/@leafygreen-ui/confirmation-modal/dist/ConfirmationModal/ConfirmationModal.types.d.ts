...
type CustomConfirmButtonProps = Omit<ButtonProps, 'variant' | 'onClick'> & CustomButtonOnClick;
type CustomCancelButtonProps = Omit<ButtonProps, 'onClick'> & CustomButtonOnClick;
...
export {};
//# sourceMappingURL=ConfirmationModal.types.d.ts.map