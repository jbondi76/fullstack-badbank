...
export declare const TooltipAlign: {
    readonly Top: "top";
...
export declare const TooltipJustify: {
    readonly Start: "start";
    readonly Middle: "middle";
    readonly End: "end";
};
export type TooltipJustify = (typeof TooltipJustify)[keyof typeof TooltipJustify];
type ModifiedTooltipProps = Omit<TooltipProps, 'usePortal' | 'justify' | 'align' | 'onClick' | 'trigger' | 'triggerEvent' | 'shouldClose' | 'className' | 'children' | 'onClose' | 'setOpen' | 'open' | 'refEl' | 'darkMode' | 'initialOpen'>;
...
export type GuideCueProps = ModifiedTooltipProps & ConditionalProps & DarkModeProps & {
    /**
